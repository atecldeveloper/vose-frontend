    ...
    return (
        <ContainerLayout>
            ...
            <SectionPdContainerLayout innerStyle={{pt: 5, pb: 10, px: {xs: 0, md: '150px !important'}}}>
                <Typography sx={{mb: 3, color: (t) => t.palette.secondary.light}}>
                ...
                <Typography variant="h6" sx={{mb: 1, color: (t) => t.palette.secondary.light}}>
                    Interpretation
                </Typography>
                ...
                <ul>
                    ...
                    <Typography sx={{color: (t) => t.palette.secondary.light}}>
                        <li>
                            Website refers to VOSÉ, accessible from https://www.vose.me
                        </li>
                    </Typography>
                    <Typography sx={{color: (t) => t.palette.secondary.light}}>
                        <li>
                ...
                <Typography variant="h6" sx={{mb: 1, fontStyle: 'italic', color: (t) => t.palette.secondary.light}}>
                    Personal Data
                </Typography>
                ...
                <Typography sx={{color: (t) => t.palette.secondary.light}}>
                    While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited toUsage Data is collected automatically when using the Service.
                    <br/><br/>
                ...
                <ul>
                    <Typography sx={{color: (t) => t.palette.secondary.light}}>
                        <li>
                            By email: vosemalaysia@hotmail.com
                        </li>
                    </Typography>
                </ul>
